...
set(PACKAGE_VERSION "0.0.1~14.g3e875da")
set(KMSMSDATA_VERSION ${PACKAGE_VERSION})

message (STATUS "Looking for KMSMSDATA: 0.0.1~14.g3e875da")
...
if (NOT "KmsMsData.hpp KmsMsDataInternal.hpp" STREQUAL " ")
  find_path(KMSMSDATA_INTERFACE_INCLUDE_DIR
    NAMES
      KmsMsData.hpp
      KmsMsDataInternal.hpp
    PATH_SUFFIXES
...
if (NOT "KmsMsDataImplFactory.hpp" STREQUAL "")
  find_path(KMSMSDATA_IMPLEMENTATION_INTERNAL_INCLUDE_DIR
    NAMES
      KmsMsDataImplFactory.hpp
    PATH_SUFFIXES
...
if (NOT "KmsMsDataImpl.hpp" STREQUAL "")
